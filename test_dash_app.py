...
model_xgb.load_model('xgb_tuned_08_noShuffle_2.json')
...
def upt_click(feature):
    ...
    if feature is not None:
        ...
        features_to_display = ['Date', 'prediction', 'lokasi']
        ...
        min_temp = data_table_lokasi[wmoid_lokasi == prop_lokasi]['min']
        avg_temp = data_table_lokasi[wmoid_lokasi == prop_lokasi]['average']
        max_temp = data_table_lokasi[wmoid_lokasi == prop_lokasi]['max']
